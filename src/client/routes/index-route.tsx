...
function NoMatch() {
  return (
    <div className="container ">
      <div className="pt-10 px-4  min-h-[80vh] justify-center">
        ...
        <center className="mt-6">
          <BackComponent className="text-gray-500 font-mono text-xl bg-gray-200 p-3 rounded-md hover:shadow-md">Go back</BackComponent>
        </center>
      </div>
    </div>
  );
